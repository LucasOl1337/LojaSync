...
grokassets/banners/marketing/pitch-deck/pattern-bg.svg
... (truncated)
```

### Change categorization (inferred from paths)
docs: patchnotes.md (1) | untracked-root: grokassets/BRAND-USAGE-GUIDELINES.md, grokassets/banners/marketing/pitch-deck/bg-v1.svg, grokassets/banners/marketing/pitch-deck/bg-v10.svg... (166) | assets: grokassets/manifest.json, grokassets/BRAND-USAGE-GUIDELINES.md, grokassets/banners/... (15) | root: grokimaginevideos/ (1)
