...
export const AUTOMATION_TARGET_FIELDS = [
  { key: "byte_empresa_posicao", label: "Posição Byte Empresa" },
  { key: "campo_descricao", label: "Campo Descrição" },
  { key: "tres_pontinhos", label: "Botão 3 pontinhos" },
...
export const GRADE_CAPTURE_FIELDS = [
  ...
  { key: "alterar_grade", label: "Botão Alterar/Definir Grade" },
  { key: "modelos", label: "Botão Modelos" },
  { key: "model_select", label: "Linha do modelo" },
  { key: "model_ok", label: "Botão OK do modelo" },
  { key: "confirm_sim", label: "Botão Sim da confirmação" },
  { key: "close_after_import", label: "Fechar intermediário" },
...
export type Scope = "products" | "totals" | "brands" | "margin" | "automation" | "history";
