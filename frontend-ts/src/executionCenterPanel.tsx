import { buildAutomationStatusDetail, formatAutomationStateLabel, type ExecutionReadinessState } from "./uiFormatting";
...
export function ExecutionCenterPanel({
  ...
  return (
    <section className="batchControlsTs" aria-labelledby="execution-center-title" aria-describedby="execution-readiness-detail">
      <div className="executionCenterHeaderTs">
        <h2 className="sectionTag" id="execution-center-title">Centro de execucao</h2>
        <span className={`executionStateChipTs ${automationIsRunning ? "executionStateRunningTs" : ""}`}>
          {automationIsRunning ? "Em execucao" : "Pronto"}
        </span>
      </div>
      <div className="batchInlineRowTs">
        <aside className="compactAutomationStatusTs" role="status" aria-live="polite" aria-label="Estado da automacao">
          <span className="automationStatusLabelTs">Automacao</span>
        ...
        <div className="executionActionClusterTs executionActionClusterPrimaryTs" role="group" aria-label="Acoes criticas de execucao">
          ...
          {automationIsRunning ? (
            <button
              ...
              title="Parar automacao em execucao"
            >
        ...
        <div className="executionActionClusterTs executionActionClusterSecondaryTs" role="group" aria-label="Acoes auxiliares de grade">
